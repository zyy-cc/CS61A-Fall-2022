...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        # player 0
        if who == 0:
            num_roll_0 = strategy0(score0, score1)
            score0 = update(num_roll_0, score0, score1, dice)
        else:
            num_roll_1 = strategy1(score1, score0)
            score1 = update(num_roll_1, score1, score0, dice)
        who = 1 - who
    # END PROBLEM 5
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    first_score = tail_points(opponent_score)
    total_score = score + first_score
    if perfect_square(total_score):
        total_score = next_perfect_square(total_score)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    # roll 0
    # zero_score = tail_points(opponent_score)
    # curr_score = score + zero_score
    # if perfect_square(curr_score):
    #     zero_score = next_perfect_square(curr_score)
    # else:
    #     zero_score = curr_score
    # # roll 6
    # six = make_averaged(roll_dice)
    # six_score = six(10)
    # curr_score_two = score + six_score
    # if perfect_square(curr_score_two):
    #     six_score = next_perfect_square(curr_score_two)
    # else:
    #     six_score = curr_score_two
    # if zero_score > six_score:
    #     return 0
    # else:
    return 6
    # END PROBLEM 12
