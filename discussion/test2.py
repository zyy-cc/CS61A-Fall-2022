...
for query in range(1, 11):
    for gamma in range(1, 11):
        print("Block2: num_set={}, gamma = {}, num_query= {}, outindex = {}".format(5, gamma/10, query, 10))
        L2 = Goldreich_Levin(turboaeBinaryBlock2, n=100, num_set=5, gamma = gamma/10, num_query=query, outindex=10)
        print("L2: {}".format(L2))
